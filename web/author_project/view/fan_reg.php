...
<!DOCTYPE HTML>
	<html lang="en-us">
		<head>
            ...
            <?php include '/author_project/common/head.php'; ?> 
            
		</head>
		<body> 
            
            <?php include '/author_project/common/header.php'; ?>
            
            <?php include '/author_project/common/nav.php'; ?>
...
<span id='noMatch' style='visibility: hidden'>Your passwords don't match</span><br>
            ...
            <?php include '/author_project/common/footer.php'; ?>
